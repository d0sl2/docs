...
В языке `d0sl` есть три основные сущности – **семантические модели и сигнатуры (а также их реализации - доменные модели)**. 
...
Любое выражение можно взять в скобки. (`(<any>)`)
